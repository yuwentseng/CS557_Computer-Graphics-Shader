...
main( ) 
{
    ...
    vec3 Normal = RotateNormal(angx,angy,vSurfaceNormal);

    vec3 reflectVector = reflect( I, Normal );
	vec3 refractVector = refract( I, Normal, uEta );
    ...
    //vec4 refractcolor = textureCube(uReflectUnit, vReflectVector)
